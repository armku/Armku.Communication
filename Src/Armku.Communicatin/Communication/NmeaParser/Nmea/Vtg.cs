...
namespace Armku.Communication.NmeaParser.Nmea
{
    ...
    public class Vtg : NmeaMessage
    {
        ...
        /// <summary>
        ///  Course over ground relative to true north 真北航向
        /// </summary>
        public double TrueCourseOverGround { get; }

        /// <summary>
        ///  Course over ground relative to magnetic north 磁北航向
        /// </summary>
        public double MagneticCourseOverGround { get; }

        /// <summary>
        /// Speed over ground in knots 地面速率节
        /// </summary>
        public double SpeedInKnots { get; }

        /// <summary>
        /// Speed over ground in kilometers/hour 地面速率公里小时
        /// </summary>
